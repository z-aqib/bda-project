...
# ============================================================
# Helper functions (AS REQUESTED – reused exactly)
# ============================================================
...
with DAG(
    ...
    def archive_raw_sensor_data():
        ...
        MONGO_DB = _env("MONGO_DB", "iot_database")
        ...
        # ----------------------------
        # Spark → Parquet (by factory)
        # ----------------------------
        spark_cmd = f"""
        /opt/spark/bin/spark-submit \
          --packages org.apache.spark:spark-sql_2.12 \
...
(df
 ...
 .write
 .mode("append")
 .partitionBy("factory_id", "year", "month", "day")
...
EOF
        ...
        metadata = {
            ...
            "data_path": HDFS_DATA_BASE,
            "policy": "30min interval, keep 1h hot data, parquet by factory"
        }
